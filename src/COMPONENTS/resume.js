const resume = `{
    ...
    "workExperience": [
          ...
          },
      {
        ...
        "responsibilities": [
          ...
          "Development and maintenance of XPDS (XPRIZE Design System)"
        ]
      },
      {
        ...
        "responsibilities": [
          ...
          "Conducted user research study to improve customer satisfaction and reduce churn rates"
        ]
      },
      {
        "title": "UI Engineer",
    ...
    "languages": [
      {
        "language": "English",
        "proficiency": "Fluent/Native Speaker"
      },
      {
        "language": "Japanese",
        "proficiency": "Basic"
    ...
    "salaryExpectations": "$130,000 - $150,000 per year (USD) base salary"
  }
`;
